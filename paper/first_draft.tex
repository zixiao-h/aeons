...
%\begin{figure*}
%\begin{center}
%	\subfloat[Gaussian: $d = 30$, $\sigma = 0.01$, $\DKL = 84$]{\includegraphics{Figures/gauss_predictions.pdf}}
%	\subfloat[\centering Wedding cake: $d = 20$, $\sigma = 0.001$, $\alpha_\mathrm{w}=0.5$, $\DKL = 93$]{\includegraphics{Figures/wedding_predictions.pdf}}
%	\subfloat[Cauchy: $d = 10$, $\gamma = 0.0001$, $\DKL = 48$]{\includegraphics{Figures/cauchy_predictions.pdf}}
%\end{center}
