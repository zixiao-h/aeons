...
Let us begin with a brief description of the nested sampling algorithm to establish the necessary notation. For a more comprehensive treatment, we recommend Skilling's paper and textbook \citet{sivia}, as well as the excellent reviews \citet{Buchner_2023} and \citet{physical_scientists}. 
\par
