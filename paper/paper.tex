...
\end{equation}
iterations after the bulk is reached. One would therefore expect a general distribution to take $\mathcal{O}(\tfrac{n d }{2}\log \tfrac{d}{2})$ iterations to get from the usual nested sampling stopping point to within an $e$-fold of the maximum, which can serve as a sanity check for the maximisation procedure. 
\par
